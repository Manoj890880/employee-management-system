...
public class EmployeeControllerTest {
  ...
  public void testUpdateEmployee() {
    ...
    ResponseEntity<EmployeeDTO> response =
        employeeController.updateEmployee(1L, updatedEmployeeDTO);
  ...
  public void testGetAllEmployeesWithoutFilters() {
    ...
    ResponseEntity<Page<EmployeeDTO>> response =
        employeeController.getAllEmployees(
            null, null, null, null, null, 0, 10, new String[] {"id", "asc"});
  ...
  public void testGetAllEmployeesWithDescendingSort() {
    ...
    ResponseEntity<Page<EmployeeDTO>> response =
        employeeController.getAllEmployees(
            null, null, null, null, null, 0, 10, new String[] {"salary", "desc"});
    ...
    assertEquals(page, response.getBody());
    verify(employeeService)
        .getAllEmployees(eq(null), eq(null), eq(null), eq(null), eq(null), any(Pageable.class));
  }

  // Helper method to create employee DTOs for testing
  private EmployeeDTO createEmployeeDTO(
      Long id, String name, String department, String email, Double salary, LocalDate joiningDate) {
