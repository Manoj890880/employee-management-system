...
public class EmployeeServiceImplTest {
    ...
    @Captor
    private ArgumentCaptor<Specification<Employee>> specCaptor;
    ...
    public void testUpdateEmployee_Success() {
        ...
        when(modelMapper.map(any(Employee.class), eq(EmployeeDTO.class))).thenReturn(updatedEmployeeDTO);
    ...
    public void testGetAllEmployees_EmptyResult() {
        ...
        // Act
        Page<EmployeeDTO> result = employeeService.getAllEmployees(null, null, null, null, null, pageable);
    ...
    public void testGetAllEmployeesWithOnlyDepartmentFilter() {
        ...
        // Act
        Page<EmployeeDTO> result = employeeService.getAllEmployees(
                department, null, null, null, null, pageable
        );
